/*
 * Setup512: Waveshare 10.85" e-Paper Display on Breakout Board
 *
 * Display: Waveshare 10.85" (1360×480) with dual JD79686AB ICs
 * Board: Seeed XIAO ESP32S3/ESP32C6 + Seeed XIAO ePaper Breakout Board
 *
 * HARDWARE MODIFICATION REQUIRED:
 * Connect display pin 1 (CSB_S) directly to D7 on XIAO
 *
 * Differences from Setup511 (Driver Board):
 * - BUSY pin: D5 (breakout board) vs D2 (driver board)
 * - All other pins identical
 *
 * Schematic Pin Reference:
 * - Primary IC CS:   CSB_M (display pin 12) → D1 via breakout board
...
// Use dual CS pin configuration for breakout board (loads from EPaper_Board_Pins_Setups.h)
#define USE_XIAO_EPAPER_BREAKOUT_BOARD_DUAL_CS_D7
